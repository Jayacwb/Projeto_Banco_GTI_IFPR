...
<body>
	...
	<h5 id="bg" class="text-center display-5 mt-3 mb-3">Depósitos</h5>
	<div id='msg'></div>	
	<?php require("efetuar_dep.php"); ?>

<div class="container-xxl">
	<form class="row g-3" method="POST" action="depositar.php">
		<div class="col-md-3">
			<label for="deposito" class="form-label">Valor $ Depósito</label>
			<input name= "deposito" type="text" class="form-control" id="deposito">
		  </div>
